          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                We're here to help you with any questions about PlateShare, from
                donating food to finding assistance. Reach out to us through any
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@plateshare.com</p>
                  <p className="text-gray-600">partnerships@plateshare.com</p>
                </div>
              </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-green-600 text-white py-3 px-6 rounded-lg hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
